...
/**
 *  Replace this sentence with a brief description of the below Model
 *  @param {Object} srcObj
 *  @param {Function} [next]
...
module.exports.replaceMe = Method
	.setLogicalHandler({filename: 'replaceMe' /* Replace this comment with options per the chosen filename */});
